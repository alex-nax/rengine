...
PRODUCT_ROOTS = ("orchestrator", "adapters", "tools", "scripts", "red")
...
PRODUCT_ALLOWED = ("editor/theme.h", "orchestrator/tests/product.mjs",
...
def product(target=None):
    ...
    print(json.dumps({"name": tokens["product"]["name"], "family": tokens["product"]["family"],
                      ...
                      "generated": ["editor/theme.h", "orchestrator/runtime/product.mjs",
                                    "red/red-core/src/theme.rs"],
