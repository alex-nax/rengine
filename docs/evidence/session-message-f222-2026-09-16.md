...
- **Not verified, and reported as a limit**: kimi's composer echo was measured by spec 149 against
...
1. **That a bracketed paste lands in a real running composer mid-conversation.** Every pane in the
   spec is this suite's own fake TUI, which behaves as spec 149 measured the real one. The running
