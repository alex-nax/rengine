...
*Renumbered from 146 to 149 when this branch merged (2026-09-17). `main` had its own spec 146 —
`146-red-agent-launch.md`, referenced by 22 files — and this one by two, so this one moved. 147 and
148 were taken by the repository-layout spec and by unmerged work on the same branch line.*
