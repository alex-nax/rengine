...
| KI-013 | Desktop tree/editor/terminal/split, live NOLF menu/input/reattachment and installed Codex with connected rEngine MCP pass on macOS. Full gameplay and the combined launch-command workflow remain unfinished. | Exercise the complete NOLF/editor/agent workflow and complete outstanding desktop criteria. Keep the active goal incomplete. |
