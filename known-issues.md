...
| KI-013 | Desktop tree/editor/terminal/split and live NOLF menu/input/reattachment tests pass on macOS. Actual installed-agent/MCP proof and full gameplay remain unfinished. | Finish bootstrap and exercise the complete NOLF/editor/agent workflow. Keep the active goal incomplete. |
