...
| KI-013 | Desktop tree/editor/terminal/split workflow passes a macOS integration test; live NOLF surface and actual installed-agent/MCP proof remain unfinished. | Implement the surface and bootstrap, then prove the actual NOLF and CLI workflow. Keep the active goal incomplete. |
