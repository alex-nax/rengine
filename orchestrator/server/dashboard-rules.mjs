...
const KIND_FIELDS = { script: ['script', 'args', 'env'], log: ['command', 'filters'], capture: ['command', 'into', 'format'] };
const KIND_REQUIRED = { script: ['script'], log: ['command'], capture: ['command', 'into', 'format'] };
...
export function dashboardRules(dashboard) {
